		...
		function init_form_fields() {
			...
			$this->form_fields = array(
				...
				'host_url' => array(
				    ...
				    'type' => 'text',
				    'description' => __( 'URL to post values to BlueFire. Default is https://secure.gobluefire.com/go/cf/checkout.php', 'woothemes' ),
				    'default' => __( 'https://secure.gobluefire.com/go/cf/checkout.php', 'woothemes' )
				),
